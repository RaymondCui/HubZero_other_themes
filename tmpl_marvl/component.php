...
<link rel="stylesheet" type="text/css" media="screen"
	...
	href="<?php echo $this->baseurl; ?>/templates/system/css/template_rtl.css" />
		<?php elseif ($this->direction == 'rtl' ) : ?>
			<link rel="stylesheet" type="text/css"
	href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/css/component.css" />
<link rel="stylesheet" type="text/css"
	href="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/css/component_rtl.css" />
