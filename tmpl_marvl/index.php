...
<body>
			...
			<div class="inner">
				<h1 class="brand">
					<a href="<?php echo $this->baseurl; ?>"
						...
						</br> <span class="sub-head">Virtual Laboratory</span>
					</a>
				</h1>

				<div id="mobile-nav" class="show-m">
					<ul>
						<li><a id="mobile-menu" href="#">
								<p id="nav-icon">
									<span></span>
								</p> <em><?php echo JText::_('TPL_HUBBASIC_MENU'); ?></em>
						</a></li>
					</ul>
				</div>
              ...
              <?php if (!$juser->get('guest')) { ?>
                <ul
                      ...
                      <img src="<?php echo $profile->getPicture(); ?>"
											alt="<?php echo $juser->get('name'); ?>"
											class="profile-pic thumb" width="30" height="30" /> <a
                ...
                <ul
                  ...
                  <?php
                    ...
                    <li id="account-register"><a
									href="<?php echo JRoute::_('index.php?option=com_register'); ?>"
	...
	<div id="wrap">
		<main id="content"
			class="<?php echo JRequest::getVar('option', ''); ?>" role="main">
		<div
			class="inner<?php if ($this->countModules('left or right')) { echo ' withmenu'; } ?>">
